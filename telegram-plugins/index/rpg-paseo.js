let handler = async (m, { bot, command }) => {
    ...
    if (!user.mascota) return m.reply("❌ No tienes una mascota. Usa *.comprarmascota* para adoptar una.");
    ...
    await bot.sendMessage(m.chat, { react: { text: accion.emoji, key: m.key }});
