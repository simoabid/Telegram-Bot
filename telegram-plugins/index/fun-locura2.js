...
_*🎶 Enviando música...*_`.trim();
        ...
        await bot.sendDocument(m.chat, img, 'imagen.jpg', info, m);
        ...
        if (result.data.url) {
            ...
            await bot.sendMessage(m.chat, { audio: { url: downloadUrl }, fileName: filename, mimetype: 'audio/mpeg', caption: `╭━❰  *YouTube*  ❱━⬣\n${filename}\n╰━❰ *${botname}* ❱━⬣`, quoted: m });
        } else {
        ...
        await bot.reply(m.chat, `❌ _*Comando Spotify Fallo Instenta Nuevamente*_`, m);
