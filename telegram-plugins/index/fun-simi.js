...
const username = `${bot.getName(m.sender)}`
...
return bot.reply(m.chat, '💛 Error: No se pudo descargar la imagen.', m, fake)}
...
await bot.reply(m.chat, description, m)

} catch (error) {

console.error('💛 Error al analizar la imagen:', error)

await bot.reply(m.chat, '💛 Error al analizar la imagen.', m)}

} else {

if (!text) { return bot.reply(m.chat, `💛 *Ingrese su petición*\n💛 *Ejemplo de uso:* ${usedPrefix + command} Como hacer un avión de papel`, m, {})}
...
await bot.reply(m.chat, 'Error: intenta más tarde.', m)}}}
