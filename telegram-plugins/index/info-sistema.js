...
// clockString function - using global version to avoid conflicts
...
`;
    ...
    try {
        await bot.sendMessage(m.chat, message.trim(), {
            parse_mode: 'Markdown'
        });
    } catch (error) {
        console.error('Error in sistema command:', error);
        await bot.sendMessage(m.chat, '❌ Error al obtener información del sistema');
    }
};
