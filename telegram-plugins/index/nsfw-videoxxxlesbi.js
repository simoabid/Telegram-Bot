...
const handler = async (m, { bot, command, usedPrefix}) => {
    try {
        // Check if NSFW is enabled in group
        ...
        if (chatInfo.type === 'group' || chatInfo.type === 'supergroup') {
            ...
            if (!global.db.data.chats[m.chat].nsfw) {
                return bot.sendMessage(m.chat, '🚩 *¡Estos comandos están desactivados!*')
            }
        }
        ...
        switch (command) {
            ...
            case 'pack2':
                ...
                await bot.sendPhoto(m.chat, url2, {
                    caption: `*🥵 Pack 2 🥵*`,
                    parse_mode: 'Markdown'
                });
                break;
            ...
            case 'pack3':
                ...
                await bot.sendPhoto(m.chat, url3, {
                    caption: `*🥵 Pack 3 🥵*`,
                    parse_mode: 'Markdown'
                });
                break;
            ...
            case 'vídeoxxx':
                ...
                await bot.sendVideo(m.chat, url4, {
            ...
            case 'pornolesv':
                ...
                await bot.sendVideo(m.chat, url5, {
                    caption: `*ᴅɪsғʀᴜᴛᴀ ᴅᴇʟ ᴠɪᴅᴇᴏ 🥵*`,
                    parse_mode: 'Markdown'
                });
                break;
