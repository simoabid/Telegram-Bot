// Fun facts plugin for Telegram
const packname = 'Barboza Bot';
const dev = 'Barboza Team';
const channel = 'https://github.com/barboza';

var handler = async (m, { bot, text }) => {
    await bot.sendMessage(m.chat, '🍭 Buscando un facto, espere un momento...', { reply_to_message_id: m.id });

    const randomFact = pickRandom(global.factos);
    await bot.sendMessage(m.chat, `*┏━_͜͡-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡⚘-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡⚘-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡⚘-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡_͜͡━┓*\n\n❥ *"${randomFact}"*\n\n*┗━_͜͡-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡⚘-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡⚘-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡⚘-͜͡-͜͡-͜͡-͜͡-͜͡-͜͡_͜͡━┛*`, { reply_to_message_id: m.id });
};
